...
const fa = {
  ...
  "Workspace": "فضای کاری",
  "CRM Studio": "استودیو CRM",
  "Business workspace": "فضای کاری کسب‌وکار",
  "Main navigation": "منوی اصلی",
  "System ready": "سامانه آماده است",
  "All services are available": "همه سرویس‌ها در دسترس‌اند",
  "Live": "زنده",
  "You are all caught up": "همه اعلان‌ها را دیده‌اید",
  "New activity will appear here": "فعالیت‌های جدید اینجا نمایش داده می‌شوند",
  "Team member": "عضو تیم",
...
const tr = {
  ...
  "CRM Studio": "CRM Stüdyosu",
  "Business workspace": "İş çalışma alanı",
  "Main navigation": "Ana menü",
  "System ready": "Sistem hazır",
  "All services are available": "Tüm hizmetler kullanılabilir",
  "Live": "Canlı",
  "You are all caught up": "Tüm bildirimleri gördünüz",
  "New activity will appear here": "Yeni etkinlikler burada görünecek",
